...
package finalproject.broker_dimension_0_1;
...
/**
 * Job: Broker_Dimension Purpose: <br>
 * Description: <br>
 * 
 * @author R, Sahitya
 ...
 * @status
 */
public class Broker_Dimension implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Broker_Dimension.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Broker_Dimension.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (brokerId != null) {
				...
				this.setProperty("brokerId", brokerId.toString());
	...
	private final String jobName = "Broker_Dimension";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Broker_Dimension.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Broker_Dimension.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void ExecutionLogStart_1_tPrejob_1Process(final java.util.Map<String, Object> globalMap)
		...
		org.slf4j.MDC.put("_subJobPid", "TNaqQB_" + subJobPidCounter.getAndIncrement());
	...
	public void ExecutionLogStart_1_tDBConnection_1Process(final java.util.Map<String, Object> globalMap)
		...
		org.slf4j.MDC.put("_subJobPid", "1bs5O0_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_ExecutionLogStart_1_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_ExecutionLogStart_1_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:pXKfW3R4Ehc807Bq2n6tb2/4ZjU5MGLq6BkL7BxmtzcMF+8=")
									.substring(0, 4) + "...");
							log4jParamters_ExecutionLogStart_1_tDBConnection_1.append(" | ");
							log4jParamters_ExecutionLogStart_1_tDBConnection_1
				...
				final String decryptedPassword_ExecutionLogStart_1_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword(
								"enc:routine.encryption.key.v1:X93bh9d717+rHs2wMTVYSm2+i2GngtQ9ukHdC4CcdJKIz7o=");
	...
	public static class ExecutionLogStart_1_out1Struct
		...
		final static byte[] commonByteArrayLock_FINALPROJECT_Broker_Dimension = new byte[0];
		static byte[] commonByteArray_FINALPROJECT_Broker_Dimension = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINALPROJECT_Broker_Dimension) {
	...
	public void ExecutionLogStart_1_tDBInput_1Process(final java.util.Map<String, Object> globalMap)
		...
		org.slf4j.MDC.put("_subJobPid", "gwALx9_" + subJobPidCounter.getAndIncrement());
...
///////////////////////    			
	...
	public static class ExecutionLogStart_1_row2Struct
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINALPROJECT_Broker_Dimension.length) {
					if (length < 1024 && commonByteArray_FINALPROJECT_Broker_Dimension.length == 0) {
						commonByteArray_FINALPROJECT_Broker_Dimension = new byte[1024];
					} else {
						commonByteArray_FINALPROJECT_Broker_Dimension = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINALPROJECT_Broker_Dimension, 0, length);
				strReturn = new String(commonByteArray_FINALPROJECT_Broker_Dimension, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_FINALPROJECT_Broker_Dimension, 0, length);
				strReturn = new String(commonByteArray_FINALPROJECT_Broker_Dimension, 0, length, utf8Charset);
			}
			return strReturn;
		}
	...
	public void ExecutionLogStart_1_tRowGenerator_1Process(final java.util.Map<String, Object> globalMap)
		...
		org.slf4j.MDC.put("_subJobPid", "SUXWlO_" + subJobPidCounter.getAndIncrement());
...
///////////////////////    			
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public Boolean max_broker_idIsNullable() {
			return true;
		}

		public Boolean max_broker_idIsKey() {
			return false;
		}

		public Integer max_broker_idLength() {
			return 10;
		}

		public Integer max_broker_idPrecision() {
			return 0;
		}

		public String max_broker_idDefault() {

			return "";

		}

		public String max_broker_idComment() {

			return "";

		}

		public String max_broker_idPattern() {

			return "";

		}

		public String max_broker_idOriginalDbColumnName() {

			return "max_broker_id";
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINALPROJECT_Broker_Dimension) {
				...
				try {
					...
					this.max_broker_id = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.max_broker_id, dos);
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("max_broker_id=" + String.valueOf(max_broker_id));
			sb.append("]");
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "bgRD8k_" + subJobPidCounter.getAndIncrement());
...
// ###############################
					...
					class BytesLimit65535_tDBInput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2
									.append("CONNECTION" + " = " + "ExecutionLogStart_1_tDBConnection_1");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("TABLE" + " = " + "\"broker\"");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("QUERYSTORE" + " = " + "\"\"");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("QUERY" + " = "
									+ "\"select coalesce(max(broker_id),0) as max_broker_id from broker\"");
							log4jParamters_tDBInput_2.append(" | ");
				...
				String dbquery_tDBInput_2 = "select coalesce(max(broker_id),0) as max_broker_id from broker";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							row1.max_broker_id = null;
						} else {

							row1.max_broker_id = rs_tDBInput_2.getInt(1);
						...
						{ // start of Var scope
							...
							Var.var1 = context.brokerId = row1.max_broker_id + 1;// ###############################
							// ###############################
							// # Output tables
...
// ###############################      
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		...
		public Boolean broker_idIsNullable() {
			return true;
		}

		public Boolean broker_idIsKey() {
			return false;
		}

		public Integer broker_idLength() {
			return null;
		}

		public Integer broker_idPrecision() {
			return null;
		}

		public String broker_idDefault() {

			return "";

		}

		public String broker_idComment() {

			return "";

		}

		public String broker_idPattern() {

			return "";

		}

		public String broker_idOriginalDbColumnName() {
		...
		public Boolean broker_nameIsNullable() {
			return true;
		}

		public Boolean broker_nameIsKey() {
			return false;
		}

		public Integer broker_nameLength() {
			return null;
		}

		public Integer broker_namePrecision() {
			return null;
		}

		public String broker_nameDefault() {

			return null;

		}

		public String broker_nameComment() {

			return "";

		}

		public String broker_namePattern() {

			return "";

		}

		public String broker_nameOriginalDbColumnName() {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "uz02yB_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1
									.append("CONNECTION" + " = " + "ExecutionLogStart_1_tDBConnection_1");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"broker\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				String tableName_tDBOutput_1 = "broker";
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "broker"
						+ "` (`broker_id`,`broker_name`,`etl_load_date`) VALUES (?,?,?)";
...
// ###############################
					...
					class BytesLimit65535_tUniqRow_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tUniqRow_1.append("UNIQUE_KEY" + " = " + "[{CASE_SENSITIVE=" + ("false")
									+ ", KEY_ATTRIBUTE=" + ("true") + ", SCHEMA_COLUMN=" + ("Broker") + "}]");
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"select broker from stage\"");
							log4jParamters_tDBInput_1.append(" | ");
				...
				String dbquery_tDBInput_1 = "select broker from stage";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row2.Broker = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_1", "tDBInput_1", "tMysqlInput", "tUniqRow_1", "tUniqRow_1",
								"tUniqRow"
...
// Start of branch "row3"
						if (row3 != null) {
							...
							if (tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
								...
								// and it contains more one result from keys : row4.broker_name = '" +
								// row4HashKey.broker_name + "'");
							} // G 071
...
// # Filter conditions 
								...
								Relational.ISNULL(row4.broker_name)
									...
									out1_tmp.broker_id = Numeric.sequence("s1", context.brokerId, 1);
									out1_tmp.broker_name = row3.Broker;
...
// Start of branch "out1"
							if (out1 != null) {
								...
								if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
										...
										, "out1", "tMap_2", "tMap_2", "tMap", "tDBOutput_1", "tDBOutput_1",
										"tMysqlOutput"
								...
								if (out1.broker_id == null) {
									...
									pstmt_tDBOutput_1.setInt(1, out1.broker_id);
								}

								if (out1.broker_name == null) {
									pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(2, out1.broker_name);
								}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "out1", 2, 0, "tMap_2",
						"tMap_2", "tMap", "tDBOutput_1", "tDBOutput_1", "tMysqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void tRowGenerator_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "WkrQtK_" + subJobPidCounter.getAndIncrement());
...
// ###############################
				...
				for (int itRowGenerator_1 = 0; itRowGenerator_1 < nb_max_row_tRowGenerator_1; itRowGenerator_1++) {
					...
					if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
							...
							, "row6", "tRowGenerator_1", "tRowGenerator_1", "tRowGenerator", "tMap_3", "tMap_3", "tMap"
...
// Start of branch "out4"
					if (out4 != null) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "out4", "tMap_3", "tMap_3", "tMap", "tDBOutput_2", "tDBOutput_2", "tMysqlOutput"
						...
						if (out4.execution_ID == null) {
							...
							pstmt_tDBOutput_2.setInt(1, out4.execution_ID);
						}

						if (out4.job_end_status == null) {
							pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_2.setString(2, out4.job_end_status);
						}

						if (out4.job_end_time != null) {
							date_tDBOutput_2 = out4.job_end_time.getTime();
						...
						if (out4.execution_ID == null) {
							...
							pstmt_tDBOutput_2.setInt(4 + count_tDBOutput_2, out4.execution_ID);
						}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row6", 2, 0,
						"tRowGenerator_1", "tRowGenerator_1", "tRowGenerator", "tMap_3", "tMap_3", "tMap", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "out4", 2, 0, "tMap_3",
						"tMap_3", "tMap", "tDBOutput_2", "tDBOutput_2", "tMysqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void tDBCommit_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "UNWlM7_" + subJobPidCounter.getAndIncrement());
	...
	public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
		...
		public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
			try {
				...
				this.broker_id = readInteger(dis, ois);
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.broker_id = readInteger(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
			try {
				...
				writeInteger(this.broker_id, dos, oos);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeInteger(this.broker_id, dos, objectOut);
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "V5kHYB_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_2 - inputs:(row3,row4) outputs:(out1)
					...
					class BytesLimit65535_tDBInput_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_3
									.append("CONNECTION" + " = " + "ExecutionLogStart_1_tDBConnection_1");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("TABLE" + " = " + "\"stage\"");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("QUERYSTORE" + " = " + "\"\"");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("QUERY" + " = " + "\"select * from broker\"");
							log4jParamters_tDBInput_3.append(" | ");
							...
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append(
									"TRIM_COLUMN" + " = " + "[{TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("broker_id")
											+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("broker_name")
											+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("etl_load_date") + "}]");
							log4jParamters_tDBInput_3.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_3", "tDBInput_3", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				conn_tDBInput_3 = (java.sql.Connection) globalMap.get("conn_ExecutionLogStart_1_tDBConnection_1");
				...
				String dbquery_tDBInput_3 = "select * from broker";
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							...
							row4.broker_id = rs_tDBInput_3.getInt(1);
						...
						if (colQtyInRs_tDBInput_3 < 3) {
							...
							if (rs_tDBInput_3.getString(3) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_3)
									...
									row4.etl_load_date = rs_tDBInput_3.getTimestamp(3);
								} else {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row4", "tDBInput_3", "tDBInput_3", "tMysqlInput", "tAdvancedHash_row4",
						...
						row4_HashRow.broker_id = row4.broker_id;
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row4", 2, 0,
						"tDBInput_3", "tDBInput_3", "tMysqlInput", "tAdvancedHash_row4", "tAdvancedHash_row4",
	...
	public void tLogCatcher_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "6UkODz_" + subJobPidCounter.getAndIncrement());
				...
				try {
					for (LogCatcherUtils.LogCatcherMessage lcm : tLogCatcher_1.getMessages()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row9", "tLogCatcher_1", "tLogCatcher_1", "tLogCatcher", "tMap_4", "tMap_4", "tMap"
...
// # Output table : 'out7'
							...
							out7 = out7_tmp;
							log.debug("tMap_4 - Outputting the record " + count_out7_tMap_4
...
// Start of branch "out7"
						if (out7 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "out7", "tMap_4", "tMap_4", "tMap", "tDBOutput_3", "tDBOutput_3", "tMysqlOutput"
...
// # Lookup hashes releasing
// ###############################      
				log.debug("tMap_4 - Written records count in the table 'out7': " + count_out7_tMap_4 + ".");

				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row9", 2, 0,
						"tLogCatcher_1", "tLogCatcher_1", "tLogCatcher", "tMap_4", "tMap_4", "tMap", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "out7", 2, 0, "tMap_4",
						"tMap_4", "tMap", "tDBOutput_3", "tDBOutput_3", "tMysqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "L6PIjh_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final Broker_Dimension Broker_DimensionClass = new Broker_Dimension();

		int exitCode = Broker_DimensionClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Broker_Dimension' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'Broker_Dimension' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_DENScOIlEe61RsadHSnvdg");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-03-23T07:25:12.774615Z");
		...
		try {
			...
			java.io.InputStream inContext = Broker_Dimension.class.getClassLoader()
					.getResourceAsStream("finalproject/broker_dimension_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Broker_Dimension.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					context.setContextType("brokerId", "id_Integer");
					if (context.getStringValue("brokerId") == null) {
						context.brokerId = null;
					} else {
						try {
							context.brokerId = routines.system.ParserUtils
									.parseTo_Integer(context.getProperty("brokerId"));
						} catch (NumberFormatException e) {
							log.warn(String.format("Null value will be used for context parameter %s: %s", "brokerId",
									e.getMessage()));
							context.brokerId = null;
						}
					}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("brokerId")) {
				context.brokerId = (Integer) parentContextMap.get("brokerId");
			}
		}
		...
		log.info("TalendJob: 'Broker_Dimension' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Broker_Dimension");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'Broker_Dimension' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 390180 characters generated by Talend Cloud Data Management Platform on the
 * 23 March 2024 at 12:55:12 PM IST
 ************************************************************************************************/